...
public class BootStarterHome {
    ...
    public static void main(String[] args) {
        ...
        embeddedAppConfig.setLibAbsoluteDirs(new String[]{"/Users/gezhigang/code-new/bootapp/bootapp-example/target",
                "/Users/gezhigang/code-new/bootapp/bootapp-example-service/target"});
